...
SETIFNIL(X39_XMR_SETTING_BLEEDING_KnockOutBloodLimit, X39_XMR_SETTING_BLEEDING_StartingBlood * 0.2);
SETIFNIL(X39_XMR_SETTING_BLEEDING_MaxBleeding, X39_XMR_SETTING_BLEEDING_StartingBlood);
